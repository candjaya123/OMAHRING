    ...
    <div className="flex flex-col overflow-hidden bg-white">
      <Routes>
        ...
        >
          ...
          <Route path="promos" element={<AdminPromosView />} /> {/* 🔹 2. Tambahkan rute baru di sini */}
          <Route path="reports" element={<AdminReportsView />} /> {/* 🔹 2. Tambahkan rute baru di sini */}
          <Route path="manage-admins" element={<AdminManagementView />} /> {/* 🔹 2. Tambahkan rute baru di sini */}
        ...
        <Route path="/shop" element={<ShoppingLayout />}>
          ...
          <Route path="membership" element={<MembershipPage />} /> {/* 🔹 2. Tambahkan rute baru di sini */}
        </Route>
